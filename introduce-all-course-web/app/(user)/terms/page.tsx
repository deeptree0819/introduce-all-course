...
const TermsPage = () => {
  return (
    <section className="mx-auto w-full max-w-[700px] items-center p-4 text-sm delay-150 duration-300 laptop:py-14 laptop:text-base">
      <h1 className="mb-4 text-2xl font-semibold laptop:text-2xl desktop:text-4xl">
        딥트리 이용약관
      </h1>

      <Separator className="mb-8 mt-5" />

      <h1 className="mb-4 text-xl font-semibold laptop:text-2xl desktop:text-2xl">
        제1장 총칙
      </h1>
      ...
      <p className="mb-4">
        ...
        &quot;회사&quot;라 합니다)가 제공하는 플랫폼을 통하여 제공하는 서비스 및
        관련 제반 서비스(이하 &quot;서비스&quot;라 합니다)의 이용에 대한 회사와
        회원 간의 권리 · 의무, 책임사항 및 기타 필요한 사항을 규정함으로써 상호
        간의 이해관계를 합리적으로 조정하고, 이에 대한 원활한 서비스 시스템이
        운영 및 유지될 수 있도록 하는 것을 목적으로 합니다.
      </p>
      ...
      <ol className=" mb-4 list-inside list-decimal text-sm laptop:text-base">
        <li className="mb-2">
          ...
          &quot;플랫폼&quot;이라 합니다)에서 제공하는 서비스 및 이와 관련한 제반
          서비스 전반을 의미합니다.
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          <strong>&quot;이용자&quot;</strong>는 본 약관에서 ‘회원’ 및 ‘비회원’을
          동시에 지칭하는 용어로 사용됩니다.
        </li>
        <li className="mb-2">
          <strong>&quot;아이디(ID)&quot;</strong>는 회원의 식별을 위하여 회원이
          설정하고 회사가 승인하여 등록된 전자우편 주소 또는 소셜 아이디
          로그인을 통하여 수집된 전자우편 주소를 의미합니다.
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          ...
          유료서비스 이용 시 결제수단으로 사용할 수 있도록 회사에서 정한 조건에
          따라 제공하는 것으로 플랫폼 내에서만 사용이 가능한 인터넷 상의
          지급수단(사이버 머니)을 의미합니다.
        </li>
        <li className="mb-2">
      ...
      <ol className=" mb-4 list-inside list-decimal text-sm laptop:text-base">
        <li className="mb-2">
          회사는 본 약관의 내용을 회원이 쉽게 알 수 있도록 사이트의 초기 화면에
          게시합니다.
        </li>
        <li className="mb-2">
          회사는 약관의규제에관한법률, 정보통신망이용촉진및정보보호등에관한법률
          (이하 &quot;정보통신망법&quot;) 등 관련 법령을 위배하지 않는 범위에서
          본 약관을 개정할 수 있으며, 개정된 약관은 사이트에 공지함으로써 효력이
          발생합니다.
        </li>
        <li className="mb-2">
      ...
      <p className="mb-4">
        ① 회사가 제공하는 서비스에 관한 이용계약은 서비스를 이용하고자 하는 자의
        이용신청 (회원가입 신청)에 대하여 회사가 승낙함으로써 성립합니다.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        확인 등 서비스 품질개선을 위하여 회원들의 개인정보를 제외한 PC 등 단말기
        설정 및 사양정보와 시스템 정보, 오류 정보를 수집 · 활용할 수 있습니다.
      </p>
      <p className="mb-4">
        ② 회사는 회사가 제공하는 서비스와 관련하여 채팅, 상담(유선상담 포함),
        서비스에 대한 의견 내지 정보를 작성 · 게시할 수 있는 게시판 등을 통하여
        회사와 회원 간에 이루어지는 모든 소통 내용을 저장, 보관할 수 있으며,
        아래의 목적으로 열람 또는 사용할 수 있습니다.
      </p>
      <ol className=" mb-4 list-inside list-decimal text-sm laptop:text-base">
        <li className="mb-2">
        ...
        <li className="mb-2">
          회사의 서비스 개발을 위하여 필요하다고 인정하는 경우. 단, 개인정보 등
          회원의 권리를 침해하지 않는 범위 내에서만 가능
        </li>
      </ol>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ① 회사는 회원의 계정정보를 통하여 서비스 이용가능 여부 등 회원의 서비스
        이용에 대한 관리 및 이에 필요한 제반 업무를 수행합니다.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ① 회원은 본 약관에 따라 회사에 정보를 제공해야 하는 경우, 진실된 정보를
        제공하여야 하며, 허위정보 제공으로 인하여 발생한 불이익 내지 손해에
        대해서는 해당 회원에게 그 책임이 있습니다.
      </p>
      <p className="mb-4">
        ② 회원은 플랫폼을 통하여 언제든지 본인의 계정정보 내역을 열람하고 수정할
        수 있습니다. 다만, 회사의 서비스 관리를 위해 필요한 경우 계정정보의 일부
        정보는 수정이 불가능할 수 있습니다.
      </p>
      <p className="mb-4">
      ...
      <ul className=" mb-4 list-inside list-disc text-sm laptop:text-base">
      ...
      <p className="mb-4">
        ...
        서비스를 개시합니다. 단, 회사가 필요한 경우 일부 서비스는 특정 시점부터
        개시할 수 있습니다. 이러한 경우 회사는 사전 또는 사후에 이를 공지합니다.
      </p>
      <p className="mb-4">
      ...
      <ol className=" mb-4 list-inside list-decimal text-sm laptop:text-base">
        <li className="mb-2">
          컴퓨터 등 정보통신설비의 보수점검, 교체, 정기점검 또는 서비스의 수정을
          위하여 필요한 경우
        </li>
        <li className="mb-2">
      ...
      <p className="mb-4">
        ...
        전화, 알림 등의 방법으로 회원에게 전달하거나 플랫폼에 게시하는 방법으로
        제공할 수 있습니다. 회원은 원하지 않을 경우 회사가 제공하는 방법에 따라
        수신을 거부할 수 있습니다.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ③ 플랫폼에는 배너와 링크(Link) 등 다양한 형태의 광고가 포함될 수 있으며,
        이는 제3자가 제공하는 페이지와 연결될 수 있습니다.
      </p>
      <p className="mb-4">
        ④ 제3항에 따라 제3자가 제공하는 페이지로 연결될 경우, 해당 페이지는
        회사의 서비스 영역이 아니므로 회사가 신뢰성, 안정성 등을 보장하지 않으며
      ...
      <p className="mb-4">
        ...
        통하여 서비스 이용금액을 지불해야 합니다. 다만, 결제수단은 회사의 정책에
        따라 변경될 수 있습니다. 이 과정에서 이루어지는 전자금융거래에 대하여는
        전자금융거래 서비스를 제공하는 회사의 정책이 적용됩니다.
      </p>
      <ol className=" mb-4 list-inside list-decimal text-sm laptop:text-base">
        <li className="mb-2">
      ...
      <p className="mb-4">
        ③ 회사는 회원의 결제에 법적, 기술적인 문제가 발생하거나 회사가 예상하지
        못한 장애 등의 사유가 발생하는 경우, 결제수단의 변경을 요청하거나 결제
        보류, 결제 거부 등의 조치를 취할 수 있습니다. 회원이 결제 과정에서
        입력한 결제 정보와 관련하여 발생한 책임과 불이익은 해당 회원이
        부담합니다.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ② 단, 이 약관의 환불 규정에 따라 환급해야 할 금액에서 체납된 이용요금이
        있거나, 상품을 일부 소비하였을 경우 우선 공제하고 남은 금액을 반환한다.
      </p>
      <p className="mb-4">
        ③ 회사는 유료서비스 별 환불정책을 운영하며, 회원이 결제한 수단과 동일한
        수단으로 환불하는 것을 원칙으로 합니다. 따라서 회원은 자신이 결제한
        유료서비스의 환불정책을 반드시 확인하고 이를 준수해야 할 의무를
        부담합니다.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        등을 타인에게 양도 및 증여할 수 없으며, 이를 담보로 제공할 수 없습니다.
      </p>
      ...
      <p className="mb-4">
        ...
        신청(회원탈퇴)을 할 수 있습니다. 이 경우 회사는 회원의 본인여부 확인 등
        필요한 절차를 요구할 수 있으며, 신속히 처리하도록 노력합니다.
      </p>
      <p className="mb-4">
      ...
      <ol className=" mb-4 list-inside list-decimal text-sm laptop:text-base">
        ...
        <li className="mb-2">범죄적 행위에 결부된다고 인정되는 내용일 경우</li>
        <li className="mb-2">
      ...
      <p className="mb-4">
        ...
        서비스를 이용할 수 있는 이용권한만을 회원에게 부여하며, 회원은 서비스를
        이용하여 얻은 정보를 가공, 판매하는 행위 등 플랫폼에 게재된 콘텐츠를
        상업적으로 사용할 수 없으며, 이를 유상양도, 판매, 담보제공 등의
        처분행위를 할 수 없습니다.
      </p>
      <p className="mb-4">
      ...
      <ol className="list-decimal pl-6">
        ...
        <li className=" mb-2 text-sm laptop:text-base">
          ...
          데이터 삭제로 인한 책임을 부담하지 않습니다. 다만, 해지 이후에도 일정
        ...
        <li className=" mb-2 text-sm laptop:text-base">
          ...
          비용 등을 포함하되 이에 한정하지 아니함)를 배상하고 회사를 면책하여야
          합니다.
        </li>
      </ol>
      ...
      <p className="mb-4">
        ...
        플랫폼 내에서 안내합니다. 회사는 이러한 회원의 의견이나 불만을 처리하기
        위한 전담조직을 운영할 수 있습니다.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        회원이 등록한 전자우편, 전화번호 및 기타의 방법을 통하여 할 수 있습니다.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ② 회원의 서비스 이용과정에서 다른 회원과의 관계에서 분쟁이 발생한 경우,
        회사는 회사의 고의 또는 중과실이 없는 한 분쟁에 개입하거나 관여하지
        않으며, 이에 대한 일체의 책임분담을 하지 않습니다.
      </p>
      <p className="mb-4">
