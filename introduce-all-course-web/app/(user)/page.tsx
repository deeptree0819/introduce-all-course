...
const MainPage = () => {
  return (
    <main>
      ...
      <section className="bg-[#EDF6FF] py-9">
        <div className="mx-auto max-w-[1300px] laptop:px-24">
          <h1 className="px-4 text-base laptop:px-0 laptop:text-2xl">
            씹고 뜯고 배우는 <span className="font-bold">로봇AI 행사 🤖</span>
          </h1>
          <EventCarousel />
        </div>
      </section>
      ...
      <section className="bg-[#F2FEFF] py-9">
        <div className="mx-auto max-w-[1300px] laptop:px-24">
          <h1 className="px-4 text-base laptop:px-0 laptop:text-2xl">
            <span className="font-bold">지금 놓치면 손해보는</span> 무료 강의 👆
          </h1>
          <FreeLectureCarousel />
        </div>
      </section>
