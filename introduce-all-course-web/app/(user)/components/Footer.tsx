...
const Footer = () => {
  return (
    <footer className="row-span-2 grid w-full gap-y-10 px-5 py-12 desktop:row-span-1 desktop:grid-cols-3 desktop:px-32 desktop:py-16">
      ...
      <div className="flex flex-col gap-y-3 desktop:order-first desktop:col-span-2">
        <div className="text-xs font-medium text-slate-500">
          (주) 딥트리 | 대표이사 이체은
        </div>
