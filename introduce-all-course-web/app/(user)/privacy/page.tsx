  ...
  return (
    <section className="mx-auto w-full max-w-[700px] items-center p-4 text-sm delay-150 duration-300 laptop:py-14 laptop:text-base">
      ...
      <p className="mb-4">
        ...
        관한 법률』, 『통신비밀보호법』, 『전기통신사업법』, 『개인정보보호법』
        등 정보통신서비스제공자가 준수하여야 할 관련 법령상의 개인정보보호
        규정을 준수하며, 관련 법령에 의거한 개인정보처리방침을 정하여 이용자의
        권익 보호에 최선을 다하고 있습니다. 본 개인정보처리방침은 이용자가
        회사가 관리 · 운영하는 서비스 플랫폼(웹, 모바일 웹 · 앱 포함, 이하
        &apos;플랫폼&apos;이라 합니다)에서 제공하는 서비스(이하
        &apos;서비스&apos;라 합니다)를 이용함에 적용되며, 다음과 같은 내용을
        담고 있습니다.
      </p>
      ...
      <ul className="ml-8 list-disc text-sm laptop:text-base">
        <li className="mb-2">
          소비자의 불만 또는 분쟁처리에 관한 기록 보존이유: 전자상거래 등에서의
          소비자보호에 관한 법률 보존기간: 3년
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          서비스 이용 및 접속에 관한 로그기록 보존이유: 통신비밀보호법 보존기간:
          3개월
        </li>
      </ul>
      ...
      <ol className="ml-8 list-decimal text-sm laptop:text-base">
        <li className="mb-2">개인정보의 열람 및 정정 범위</li>
        <ul className="ml-8 list-disc">
          <li className="mb-2">회사가 보유하고 있는 이용자의 개인정보</li>
          <li className="mb-2">회사가 이용하거나 제3자에 제공한 개인정보</li>
          <li className="mb-2">개인정보의 수집, 이용, 제공 등의 동의 현황</li>
        </ul>
        ...
        <ul className="ml-8 list-disc">
          ...
          <li className="mb-2">
            ...
            않습니다.
            <br />
            [운영시간] 월요일~금요일: 10:30~17:30 점심시간 : 12:30~14:00(평일)
          </li>
        </ul>

        <li className="mb-2">회원 탈퇴</li>
        <ul className="ml-8 list-disc">
          <li className="mb-2">
